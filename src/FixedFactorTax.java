 ...
 * το άθροισμα των τριων χαρακτηριστηκών πολλαπλασιασμένα με τον συντελεστή τους. Για τα σπίτια ο υπολογισμός του
 * φόρου γίνεται αθροίζοντας τα 4 χαρακτηριστηκά του κάθε σπιτιού πολλαπλασιασμένα το καθένα με έναν σταθερό
 * συντελεστή 0.25.
 *
 ...
 * its factor. The tax for a house is calculated by summing its 4 characteristics each one multiplied by a
 * constant factor 0.25.
 */
